...
export const PROPERTIES: Property[] = [
  ...
  },
  {
    ...
    slug: 'bishop-ohana',
    name: 'Bishop Ohana',
    tagline: 'Hot Tub · Indoor & Outdoor Fireplaces · Sleeps 12 · Dog Friendly',
    location: 'Pinetop',
    locationDisplay: 'Pinetop-Lakeside, AZ',
    rating: 5.0,
    reviewCount: 0,
    ...
    guests: 12,
    images: [
      'https://uc.orez.io/i/1d7dfc7cf2d34ad7893755663065e616-Large',
    ],
    amenities: ['Hot Tub', 'Outdoor Fireplace', 'Indoor Gas Fireplace', 'Dog Friendly', 'Game Loft', 'Basement Playroom', 'Dedicated Workspace', 'Full Kitchen', 'Forest Views', 'Fast WiFi'],
    description: 'Spacious 3-bedroom Pinetop cabin with a private hot tub, indoor and outdoor fireplaces, a game loft, and forest views — sleeps 12, and dogs are welcome.',
    longDescription: 'Welcome to Bishop Ohana — a spacious 2,300+ sq ft cabin tucked into the pines of Pinetop-Lakeside, built for family togetherness ("ohana" means family). With 3 bedrooms plus a finished basement and loft, it sleeps up to 12 and welcomes your dogs, making it the perfect base for a White Mountains getaway.\n\nThe main-level master suite offers a restful retreat with its own bath, while a second bedroom and a bright loft give everyone room to spread out. Downstairs, the finished basement adds a bedroom, a full bathroom, and a dedicated kids\' playroom — plus a home office with a dedicated workspace for anyone who needs to stay connected. Two and a half baths keep busy mornings easy.\n\nGather in the family room by the indoor gas fireplace, cook together in the full kitchen, and take in the views for days from the deck. Step outside to melt into the private hot tub or gather around the outdoor fireplace on cool mountain evenings. Just minutes from Woodland Lake, golf, hiking, and Sunrise Park Resort, Bishop Ohana is where your family will want to come back year after year.',
    featured: true,
    highlight: false,
    pets: true,
    ownerRezPropertyId: 488048,
  },
]
